				...
				return this.each(
					...
					if(o.addPagination && !$(pagination).length){
						...
						$(o.slides,$t).children().each(function(){
							if (number<buttons) {
								$("."+o.pagination,$t).append("<li><a data-href="+(number+1)+" href=\"#\" >"+(number+1)+"</a></li>");
								number = number+1;
							} else {
								number = 0;
								return false;
					...
					function current(times) {
						...
						$(pagination,$t).parent().siblings().removeClass("active");
						$(pagination+"[data-href='" + (times) + "']",$t).parent().addClass("active");
					};
